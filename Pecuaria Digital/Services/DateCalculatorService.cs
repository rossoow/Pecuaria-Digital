...
{
    /// <summary>
    /// Calcula as datas das etapas do protocolo a partir do D0.
    /// Regra: D8 = D0 + 8 dias | IATF = D8 + 2 dias | DG = IATF + 30 dias
    /// </summary>
    public class DateCalculatorService
    {
        public DateTime CalcularD8(DateTime d0) => d0.AddDays(Protocolo.DiasD0ParaD8);
        public DateTime CalcularIATF(DateTime d8) => d8.AddDays(Protocolo.DiasD8ParaIATF);
        public DateTime CalcularDG(DateTime iatf) => iatf.AddDays(Protocolo.DiasIATFParaDG);
